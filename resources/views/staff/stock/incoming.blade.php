...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
        <h1 class="text-2xl font-bold text-emerald-600 dark:text-emerald-400">
            Daftar Barang Masuk (Pending Approval)
        </h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
            Konfirmasi transaksi stok yang diajukan manager
        </p>
    </div>
    @if(session('success'))
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
        ...
        <table class="min-w-full text-sm">
            ...
            <thead class="bg-emerald-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300">
                <tr>
